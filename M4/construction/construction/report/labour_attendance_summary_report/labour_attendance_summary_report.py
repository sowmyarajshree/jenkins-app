...
def get_columns(filters):
    if filters.get('attendance_type') == "Subcontractor":
        return[
                    ...
                    {"label": "Nos", "fieldname": "qty", "fieldtype": "Float", "width":80},
                    {"label": "Lab Work Hrs", "fieldname": "sum_of_working_hrs", "fieldtype": "Float", "width":150}
                ]
        ...
        return[    
                    ...
                    {"label": "NMR Work Hrs", "fieldname": "total_working_hours", "fieldtype": "Float", "width":200} 
                ] 
    else:          
        return[    
                    ...
                    {"label": "Nos", "fieldname": "qty", "fieldtype": "Float", "width":80},
                    {"label": "Lab Work Hrs", "fieldname": "sum_of_working_hrs", "fieldtype": "Float", "width":120},
          			{"label": "Muster Roll", "fieldname": "muster_roll", "fieldtype": "Link", "options": "Muster Roll", "width":130},
                    {"label": "NMR Work Hrs", "fieldname": "total_working_hours", "fieldtype": "Float", "width":130}
	            ]
...
def get_data(filters):
	...
	return frappe.db.sql("""
        ...
        WHERE 
         labour_attendance.docstatus = 1 %s 
        order by
        	labour_attendance.project""" % conditions, filters, as_dict=1)
